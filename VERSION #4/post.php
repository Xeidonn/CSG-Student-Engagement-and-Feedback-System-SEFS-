...
function renderComment($comment, $post_id, $level = 0) {
    ...
    echo "<span class='comment-date text-muted ms-2'>" . timeAgo($comment['created_at']) . "</span>";
    ...
    if (isLoggedIn()) {
        ...
        if ($isOwner) {
            echo "<button class='btn btn-sm btn-outline-secondary ms-2'>Edit</button>";
            echo "<button class='btn btn-sm btn-outline-danger ms-2'>Delete</button>";
        }
        echo "</div>";
                ...
                <div class="post-card">
                    <div class="post-header">
                        ...
                        <div class="post-meta">
                            ...
                            <span><i class="fas fa-clock me-1"></i><?= timeAgo($post['created_at']) ?></span>
